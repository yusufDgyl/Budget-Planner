...
{
    public class IslemTur : Ortak_Alanlar , IOrtak_Metotlar
    {
        public IslemTur(VeritabaniIslemleri _veritabaniIslemleri)
        {
        ...
        public const string C_Tablo = "dbo.IslemTur";

        public const string C_Sp_Ekle = "dbo.SP_IslemTur_EKLE";
        public const string C_Sp_Sil = "dbo.SP_IslemTur_SIL";
        public const string C_Sp_Guncelle = "dbo.SP_IslemTur_GUNCELLE";
        public const string C_Sp_Doldur = "dbo.SP_IslemTur_DOLDUR";
        public const string C_Sp_TumunuGetir = "dbo.SP_IslemTur_TUMUNU_GETIR";
